...
strategist_llm = InternS1API(api_key=API_KEY, max_new_tokens=512, temperature=0.2)
...
solver_llm = InternS1API(api_key=API_KEY, max_new_tokens=16384, temperature=0.2)
...
class InferencePipeline:
    ...
    def solve(self, problem: str, verbose: bool = True, max_retries: int = 2) -> dict:
        t0 = time.time()
